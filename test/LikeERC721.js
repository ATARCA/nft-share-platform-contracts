...
describe("Likeable ERC721 contract", function() {
  ...
  it("Should be able to like an existing contribution", async function() {
    ...
    expect(e_minting).to.emit(instanceLikeTokenContract, "Transfer").withArgs(ethers.constants.AddressZero, addr2.address, s_tokenId)
  ...
  it("Should not be able to like same contribution twice from same address", async function() {
    ...
    expect(e_minting).to.emit(instanceLikeTokenContract, "Transfer").withArgs(ethers.constants.AddressZero, addr1.address, 0)
  ...
  it("Should be able to like same contribution from different wallets", async function() {
    ...
    expect(e_minting_w2).to.emit(instanceLikeTokenContract, "Transfer").withArgs(ethers.constants.AddressZero, addr2.address, 1)
